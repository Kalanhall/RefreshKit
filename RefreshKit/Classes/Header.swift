...
open class DefaultRefreshHeader: UIView, RefreshableHeader {
    ...
    override init(frame: CGRect) {
        ...
        let image = UIImage.rk_image(named: "arrow_down", in: Bundle(for: DefaultRefreshHeader.self))
        ...
        self.isHidden = true
        // Default text
        textDic[.pullToRefresh] = RefreshKitHeaderString.pullDownToRefresh
        textDic[.releaseToRefresh] = RefreshKitHeaderString.releaseToRefresh
        textDic[.refreshSuccess] = RefreshKitHeaderString.refreshSuccess
        textDic[.refreshFailure] = RefreshKitHeaderString.refreshFailure
        textDic[.refreshing] = RefreshKitHeaderString.refreshing
