...
open class DefaultRefreshLeft: UIView, RefreshableLeftRight {
    ...
    override init(frame: CGRect) {
        ...
        let image = UIImage.rk_image(named: "arrow_right", in: Bundle(for: DefaultRefreshHeader.self))
        imageView.image = image
        textDic[.scrollToAction] = RefreshKitLeftString.scrollToClose
        textDic[.releaseToAction] = RefreshKitLeftString.releaseToClose
        textLabel.text = textDic[.scrollToAction]
    }
